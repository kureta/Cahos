...
class Instruments:
    ...
    bassoon = Instrument("Bassoon", 70, (34, 75))
    horn = Instrument("Horn", 60, (37, 77))  # Actually starts at 34 but reasons
    trumpet = Instrument("Trumpet", 56, (54, 84))
    trombone = Instrument("Trombone", 57, (40, 72))
    violin = Instrument("Violin", 40, (55, 103))
    viola = Instrument("Viola", 41, (48, 91))
    cello = Instrument("Violoncello", 42, (36, 76))
    contrabass = Instrument("Contrabass", 43, (28, 67))
